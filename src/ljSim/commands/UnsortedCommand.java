...
abstract public class UnsortedCommand extends Command {
 ...
 //   static private Deque<UnsortedCommand> earlyQueue= new LinkedList<UnsortedCommand>();
 //   static protected Deque<UnsortedCommand>getEarlyQueue(){return earlyQueue;}
 //   static protected void clearEarlyQueue(){earlyQueue= new LinkedList<UnsortedCommand>();}
 ...
 /*   
    protected static Command getAtask()
        {
            Command task= earlyQueue.pollFirst();
            if(task == null)return null;
            commandsPending -- ;
            String s= "Removing from the earlyQueue " + task.getName();
            s= s + " " + commandsPending + " tasks remain to do.";
       //     myMessenger.line(s);
            return task;
        }
*/   
    ...
    @Override
    protected String getMyType(){return "UnsortedCommand";}
