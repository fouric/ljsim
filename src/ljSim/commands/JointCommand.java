...
abstract public class JointCommand extends UnsortedCommand {
    ...
    public void setSource(Link x){mySource= x;}
    public Link getSource(){return mySource;}
    public Joint getTarget(){return (Joint) super.getTarget();}
    ...
    public boolean enQueueMe(Time t){return super.enQueueMe(t);}
    ...
    @Override
    protected String getMyType(){return "JointCommand";}
