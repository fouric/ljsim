...
public class SortedJointCommand extends JointCommand {
	...
	public Queue<UnsortedCommand> getMyDeque() {
		return doBefore;
	}

	public boolean addToDeque(UnsortedCommand u) {
		return doBefore.add(u);
	}

	public boolean addToDeque(Queue<UnsortedCommand> q) {
		return doBefore.addAll(q);
	}

	public int getMyQueueSize() {
		return doBefore.size();
	}
