...
public class Time 
{
    ...
    public int getMyTimeNum(){ return myTimeNum;}
 
    //the latest possible time is called farFuture
    static private int farFuture = Integer.MAX_VALUE; 
    static public Time getFarFuture(){return please(farFuture);}
    ...
    public boolean isBefore(Time x) 
        {
            ...
            if( myTimeNum >= x.myTimeNum)return false;
            return true;
        }
