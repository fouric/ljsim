...
public class Group extends Component {
    ...
    //--------- Methods to override -----------
    public void masterClear(){myMessenger.line("clearing " + getName());}
    ...
    protected String checkForCircularParentage()
        {
            ...
            if (recursionCheckBit == true)
            ...
            else //my recursion check bit is false, so check my parent
                {
                    ...
                    if(p == null) return null; // my parent is OK
                    // my  parent is NOT OK
                    return s;
                }
