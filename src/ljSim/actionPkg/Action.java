...
abstract public class Action {
 ...
 //   protected Time lastFireTime= Time.zeroTime;
    ...
    protected int getCircumference(){return circumference;}
    ...
    static protected Messenger myMessenger = Messenger.please(
            "Action class", 2);

    public Joint getMyJoint() {return myJoint;}
    public String getMyName() {return actionName;}
    public String getJointName() {return myJoint.getName();}
    public String getCombinedName() {return getJointName() + "-" + getMyName();}
    ...
    public void setMyGuardTime(Time t){ myGuardTime= t;}
    public Time getMyGuardTime(){return myGuardTime;}
    
    private TimedValue myValue= null;
    protected void setMyValue(TimedValue v){ myValue= v;}
    public TimedValue getMyValue(){return myValue;}
    ...
    protected LinkCommand getInCmd(int i){ return getMyJoint().getInCmd(i);}
    protected LinkCommand getOutCmd(int i){ return getMyJoint().getOutCmd(i);}
    ...
    static protected Time guard (LinkCommand in, LinkCommand out)
        {
            if(in == null || out == null)return null; //incomplete
    ...
    public void fireMessage(Time t)
        {
            Joint J= this.getMyJoint();
            String s= J.timeHerald(t) +  " Action " + getMyName() 
                    + " fires with use count " + J.getUseCount();
            myMessenger.line(s);
  }
