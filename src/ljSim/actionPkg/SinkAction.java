...
public class SinkAction extends Action {
    ...
    //constructor
    public SinkAction(String name, Joint parent){super (name, parent) ;}
    ...
    public boolean fire()
        {//fire drains any input Links that are FULL
            Joint J = getMyJoint();
            Time t= getMyGuardTime();
            String s= J.timeHerald(t) + " firing with useCount " + J.getUseCount()
                    + " of "  + allowedFirings + " allowed";
            myMessenger.line(s);
